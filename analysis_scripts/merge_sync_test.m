...
cd('D:\Data\Kelton\analyses\KW006\KW006_08012024_rec_D3_CA1\good')
...
for i = 1:length(root.good)
    ...
    saveas(tmpfrpos, ['unit' num2str(cc) '_posXFR_3cm'],'png')

    try 
        tmphtmp = plot_trialHeatmap(root,cc,sess);
        saveas(tmphtmp, ['unit' num2str(cc) '_trialFRHeatmap_3cm'],'png')
    catch
